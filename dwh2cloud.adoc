...
* ./dwh2cloud.pptx[Filling the gap between Third Normal Form and Big Data with PostgreSQL, Apache Kafka, and KSQL] by https://twitter.com/hussey_mic/[Mic Hussey]
